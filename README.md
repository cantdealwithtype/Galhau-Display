...
Released under the [SIL Open Font License 1.1](https://openfontlicense.org/). See `fonts/OFL.txt` for the full license text.

Copyright 2026 cantdealwithtype, Leandro Ferreira (https://cantdealwithtype.xyz) with Reserved Font Name "Galhau Display".

---

Created by [cantdealwithtype](https://cantdealwithtype.xyz/)
